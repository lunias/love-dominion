function love.conf(t)
  t.title = "Dominion"  -- The title of the window the game is in (string)
  t.author = "Ethan Anderson \"Lunias\""  -- The author of the game (string)
  t.identity = "love-dominion"  -- The name of the save directory (string)
